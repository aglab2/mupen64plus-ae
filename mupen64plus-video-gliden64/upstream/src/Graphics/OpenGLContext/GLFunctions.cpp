...
#define ASSIGN_PROC_ADR(proc_type, proc_name) g_gl##proc_name = gl##proc_name
...
#define GL_GET_PROC_ADR(proc_type, proc_name) g_gl##proc_name = (proc_type) dlsym(gles2so, "gl"#proc_name);

#elif defined(EGL)

#define glGetProcAddress eglGetProcAddress
#define GL_GET_PROC_ADR(proc_type, proc_name) g_gl##proc_name = (proc_type) glGetProcAddress("gl"#proc_name)
#define GL_GET_PROC_ADR_EGL(proc_type, proc_name) g_egl##proc_name = (proc_type) glGetProcAddress("egl"#proc_name)
...
#define GL_GET_PROC_ADR(proc_type, proc_name) g_gl##proc_name = (proc_type) glGetProcAddress((const GLubyte*)"gl"#proc_name)
...
PFNGLDEBUGMESSAGECALLBACKPROC g_glDebugMessageCallback;
PFNGLDEBUGMESSAGECONTROLPROC g_glDebugMessageControl;
PFNGLCOPYTEXIMAGE2DPROC g_glCopyTexImage2D;
PFNGLEGLIMAGETARGETTEXTURE2DOESPROC g_glEGLImageTargetTexture2DOES;
PFNGLEGLIMAGETARGETRENDERBUFFERSTORAGEOESPROC g_glEGLImageTargetRenderbufferStorageOES;
PFNEGLGETNATIVECLIENTBUFFERANDROIDPROC g_glEGLGetNativeClientBufferANDROID;
